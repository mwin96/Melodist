...
arc method.</p>
  ...
  stroke() {</pre></div>
    ...
    <span class="hljs-keyword">const</span> txt = <span class="hljs-keyword">this</span>.create(<span class="hljs-string">'text'</span>);
    <span class="hljs-keyword">if</span> (<span class="hljs-keyword">typeof</span> (txt.getBBox) !== <span class="hljs-string">'function'</span>) {
      <span class="hljs-keyword">return</span> { <span class="hljs-attr">x</span>: <span class="hljs-number">0</span>, <span class="hljs-attr">y</span>: <span class="hljs-number">0</span>, <span class="hljs-attr">width</span>: <span class="hljs-number">0</span>, <span class="hljs-attr">height</span>: <span class="hljs-number">0</span> };
    }
    ...
    <span class="hljs-keyword">let</span> bbox = txt.getBBox();
...
And then subtract the overestimate from calculated width.</p>
          ...
          <div class='highlight'><pre>
    <span class="hljs-keyword">const</span> fontSize = <span class="hljs-built_in">Number</span>(<span class="hljs-keyword">this</span>.fontSize);
    <span class="hljs-keyword">const</span> m = <span class="hljs-number">1.196</span>;
    <span class="hljs-keyword">const</span> b = <span class="hljs-number">1.9598</span>;
    <span class="hljs-keyword">const</span> widthCorrection = (m * fontSize) + b;
    <span class="hljs-keyword">const</span> width = bbox.width - widthCorrection;
    <span class="hljs-keyword">const</span> height = bbox.height - <span class="hljs-number">1.5</span>;</pre></div>
        ...
        <p>Get non-protected copy:</p>
          ...
          <div class='highlight'><pre>    <span class="hljs-keyword">const</span> box = {
      <span class="hljs-attr">x</span>: bbox.x,
      <span class="hljs-attr">y</span>: bbox.y,
      width,
      height,
    };
  ...
  save() {</pre></div>
      ...
      <span class="hljs-attr">lineWidth</span>: <span class="hljs-keyword">this</span>.lineWidth,
    });
    <span class="hljs-keyword">return</span> <span class="hljs-keyword">this</span>;
  }
  ...
  restore() {</pre></div>
    ...
    <span class="hljs-keyword">this</span>.state.scale = state.state.scale;
    ...
    <span class="hljs-keyword">this</span>.lineWidth = state.lineWidth;
    <span class="hljs-keyword">return</span> <span class="hljs-keyword">this</span>;
  }
}</pre></div>
