...
<span class="hljs-keyword">export</span> <span class="hljs-class"><span class="hljs-keyword">class</span> <span class="hljs-title">Tremolo</span> <span class="hljs-keyword">extends</span> <span class="hljs-title">Modifier</span> </span>{
  ...
  <span class="hljs-keyword">static</span> get YOFFSETSTEMUP() { <span class="hljs-keyword">return</span> <span class="hljs-number">-9</span>; }
  <span class="hljs-keyword">static</span> get YOFFSETSTEMDOWN() { <span class="hljs-keyword">return</span> <span class="hljs-number">-21</span>; }
  <span class="hljs-keyword">static</span> get XOFFSETSTEMUP() { <span class="hljs-keyword">return</span> <span class="hljs-number">6</span>; }
  <span class="hljs-keyword">static</span> get XOFFSETSTEMDOWN() { <span class="hljs-keyword">return</span> <span class="hljs-number">-2</span>; }
  <span class="hljs-keyword">constructor</span>(num) {
    <span class="hljs-keyword">super</span>();
    <span class="hljs-keyword">this</span>.setAttribute(<span class="hljs-string">'type'</span>, <span class="hljs-string">'Tremolo'</span>);
  ...
  draw() {
    ...
    <span class="hljs-keyword">if</span> (!(<span class="hljs-keyword">this</span>.note &amp;&amp; <span class="hljs-keyword">this</span>.index != <span class="hljs-literal">null</span>)) {
      <span class="hljs-keyword">throw</span> <span class="hljs-keyword">new</span> Vex.RERR(<span class="hljs-string">'NoAttachedNote'</span>, <span class="hljs-string">"Can't draw Tremolo without a note and index."</span>);
    }

    <span class="hljs-keyword">this</span>.setRendered();
    <span class="hljs-keyword">const</span> stemDirection = <span class="hljs-keyword">this</span>.note.getStemDirection();
    <span class="hljs-keyword">this</span>.y_spacing = <span class="hljs-number">4</span> * stemDirection;
    ...
    <span class="hljs-keyword">let</span> x = start.x;
    <span class="hljs-keyword">let</span> y = <span class="hljs-keyword">this</span>.note.stem.getExtents().topY;
    <span class="hljs-keyword">const</span> scale = <span class="hljs-keyword">this</span>.note.getCategory() === <span class="hljs-string">'gracenotes'</span> ? GraceNote.SCALE : <span class="hljs-number">1</span>;
    <span class="hljs-keyword">if</span> (stemDirection &lt; <span class="hljs-number">0</span>) {
    ...
    <span class="hljs-keyword">this</span>.font = {
      ...
      <span class="hljs-attr">size</span>: <span class="hljs-number">16</span> * scale,
      <span class="hljs-attr">weight</span>: <span class="hljs-string">''</span>,
    };

    <span class="hljs-keyword">this</span>.render_options = {
      <span class="hljs-attr">font_scale</span>: <span class="hljs-number">35</span> * scale,
      <span class="hljs-attr">stroke_px</span>: <span class="hljs-number">3</span>,
      <span class="hljs-attr">stroke_spacing</span>: <span class="hljs-number">10</span> * scale,
    };

    x += stemDirection &lt; <span class="hljs-number">0</span> ? Tremolo.XOFFSETSTEMDOWN : Tremolo.XOFFSETSTEMUP;
    <span class="hljs-keyword">for</span> (<span class="hljs-keyword">let</span> i = <span class="hljs-number">0</span>; i &lt; <span class="hljs-keyword">this</span>.num; ++i) {
      Glyph.renderGlyph(<span class="hljs-keyword">this</span>.context, x, y, <span class="hljs-keyword">this</span>.render_options.font_scale, <span class="hljs-keyword">this</span>.code);
