...
<span class="hljs-keyword">export</span> <span class="hljs-class"><span class="hljs-keyword">class</span> <span class="hljs-title">CanvasContext</span> </span>{
  ...
  <span class="hljs-keyword">static</span> get CANVAS_BROWSER_SIZE_LIMIT() {
    <span class="hljs-keyword">return</span> <span class="hljs-number">32767</span>; <span class="hljs-comment">// Chrome/Firefox. Could be determined more precisely by npm module canvas-size</span>
  }

  <span class="hljs-keyword">static</span> SanitizeCanvasDims(width, height) {
    <span class="hljs-keyword">if</span> (<span class="hljs-built_in">Math</span>.max(width, height) &gt; <span class="hljs-keyword">this</span>.CANVAS_BROWSER_SIZE_LIMIT) {
      Vex.W(
        <span class="hljs-string">'Canvas dimensions exceed browser limit. Cropping to '</span> +
        <span class="hljs-keyword">this</span>.CANVAS_BROWSER_SIZE_LIMIT
      );
      <span class="hljs-keyword">if</span> (width &gt; <span class="hljs-keyword">this</span>.CANVAS_BROWSER_SIZE_LIMIT) {
        width = <span class="hljs-keyword">this</span>.CANVAS_BROWSER_SIZE_LIMIT;</pre></div>
        
      
        
        <p>note: Math.min return 0 for undefined, NaN for null. Would change inputs.</p>

        
          <div class='highlight'><pre>      }
      <span class="hljs-keyword">if</span> (height &gt; <span class="hljs-keyword">this</span>.CANVAS_BROWSER_SIZE_LIMIT) {
        height = <span class="hljs-keyword">this</span>.CANVAS_BROWSER_SIZE_LIMIT;
      }
    }
...
property</p>
    ...
    <span class="hljs-keyword">if</span> (!context.canvas) {
      <span class="hljs-keyword">this</span>.canvas = {
        <span class="hljs-attr">width</span>: CanvasContext.WIDTH,
        <span class="hljs-attr">height</span>: CanvasContext.HEIGHT,
      };
...
expected.</p>
  ...
  resize(width, height) {
    [width, height] = <span class="hljs-keyword">this</span>.SanitizeCanvasDims(<span class="hljs-built_in">parseInt</span>(width, <span class="hljs-number">10</span>), <span class="hljs-built_in">parseInt</span>(height, <span class="hljs-number">10</span>));
    <span class="hljs-keyword">return</span> <span class="hljs-keyword">this</span>.vexFlowCanvasContext.resize(width, height);
  }
