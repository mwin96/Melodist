...
<span class="hljs-keyword">const</span> BEAM_LEFT = <span class="hljs-string">'L'</span>;
<span class="hljs-keyword">const</span> BEAM_RIGHT = <span class="hljs-string">'R'</span>;
<span class="hljs-keyword">const</span> BEAM_BOTH = <span class="hljs-string">'B'</span>;
...
extends into the beams.</p>
    ...
    <span class="hljs-keyword">for</span> (<span class="hljs-keyword">let</span> i = <span class="hljs-number">0</span>; i &lt; notes.length; ++i) {
      ...
      <span class="hljs-keyword">if</span> (note.isRest() &amp;&amp; show_stemlets) {
        ...
        <p>return upper level beam direction.</p>

        
          <div class='highlight'><pre>  lookupBeamDirection(duration, prev_tick, tick, next_tick) {
    if (duration === '4') {
      return BEAM_LEFT;
    }
    ...
    <span class="hljs-keyword">const</span> tick_of_duration = Flow.durationToTicks(duration);
 ...
 handle that as well.</p>
      ...
      <span class="hljs-keyword">const</span> note_gets_beam = note.getIntrinsicTicks() &lt; tick_of_duration;
 ...
 level. This will help to inform the partial beam logic below.</p>
          ...
          <div class='highlight'><pre>      <span class="hljs-keyword">const</span> prev_note = <span class="hljs-keyword">this</span>.notes[i - <span class="hljs-number">1</span>];
      <span class="hljs-keyword">const</span> next_note = <span class="hljs-keyword">this</span>.notes[i + <span class="hljs-number">1</span>];
      <span class="hljs-keyword">const</span> next_note_gets_beam = next_note &amp;&amp; next_note.getIntrinsicTicks() &lt; tick_of_duration;
      <span class="hljs-keyword">const</span> prev_note_gets_beam = prev_note &amp;&amp; prev_note.getIntrinsicTicks() &lt; tick_of_duration;
      <span class="hljs-keyword">const</span> beam_alone = prev_note &amp;&amp; next_note &amp;&amp;
      note_gets_beam &amp;&amp; !prev_note_gets_beam &amp;&amp; !next_note_gets_beam;</pre></div>
        
      
        
        <p>const beam_alone = note_gets_beam &amp;&amp; !prev_note_gets_beam &amp;&amp; !next_note_gets_beam;</p>

        
          <div class='highlight'><pre>      <span class="hljs-keyword">if</span> (note_gets_beam) {</pre></div>
 ...
 the stem X of the current note.</p>
        ...
        <p>If a secondary beam break is set up, end the beam right now.</p>
          ...
          <div class='highlight'><pre>          <span class="hljs-keyword">if</span> (should_break) {
            ...
            <span class="hljs-keyword">if</span> (next_note &amp;&amp; !next_note_gets_beam &amp;&amp; current_beam.end === <span class="hljs-literal">null</span>) {</pre></div>
 ...
 we need a partial pointing right.</p>
        ...
        <p>No beam started yet. Start a new one.</p>
          ...
          <span class="hljs-keyword">if</span> (beam_alone) {</pre></div>
        
      
        
        <p>previous and next beam exists and does not get a beam but current gets it.</p>

        
          <div class='highlight'><pre>            <span class="hljs-keyword">const</span> prev_tick = prev_note.getIntrinsicTicks();
            <span class="hljs-keyword">const</span> next_tick = next_note.getIntrinsicTicks();
            <span class="hljs-keyword">const</span> tick = note.getIntrinsicTicks();
            <span class="hljs-keyword">const</span> beam_direction = <span class="hljs-keyword">this</span>.lookupBeamDirection(duration, prev_tick, tick, next_tick);

            <span class="hljs-keyword">if</span> ([BEAM_LEFT, BEAM_BOTH].includes(beam_direction)) {
              current_beam.end = current_beam.start - partial_beam_length;
            } <span class="hljs-keyword">else</span> {
              current_beam.end = current_beam.start + partial_beam_length;
            }
          } <span class="hljs-keyword">else</span> <span class="hljs-keyword">if</span> (!next_note_gets_beam) {</pre></div>
