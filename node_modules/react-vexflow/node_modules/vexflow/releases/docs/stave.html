...
modifiers (BarLines) are automatically added upon construction.</p>
    ...
    <span class="hljs-keyword">for</span> (<span class="hljs-keyword">let</span> i = <span class="hljs-number">0</span>; i &lt; endModifiers.length; i++) {
      ...
      <span class="hljs-keyword">if</span> (layoutMetrics) {
        <span class="hljs-keyword">if</span> (i !== <span class="hljs-number">0</span>) {
          widths.right = layoutMetrics.xMax || <span class="hljs-number">0</span>;
          widths.paddingRight = layoutMetrics.paddingRight || <span class="hljs-number">0</span>;
        }
        widths.left = (-layoutMetrics.xMin) || <span class="hljs-number">0</span>;
        widths.paddingLeft = layoutMetrics.paddingLeft || <span class="hljs-number">0</span>;

        <span class="hljs-keyword">if</span> (i === endModifiers.length - <span class="hljs-number">1</span>) {
          widths.paddingLeft = <span class="hljs-number">0</span>;
        }
      } <span class="hljs-keyword">else</span> {
  ...
  draw() {
    ...
    <span class="hljs-keyword">const</span> num_lines = <span class="hljs-keyword">this</span>.options.num_lines;
    <span class="hljs-keyword">const</span> width = <span class="hljs-keyword">this</span>.width;
    <span class="hljs-keyword">const</span> x = <span class="hljs-keyword">this</span>.x;
    <span class="hljs-keyword">let</span> y;</pre></div>
        ...
        <p>Render lines</p>
          ...
          <div class='highlight'><pre>    <span class="hljs-keyword">for</span> (<span class="hljs-keyword">let</span> line = <span class="hljs-number">0</span>; line &lt; num_lines; line++) {
      ...
      <span class="hljs-keyword">if</span> (<span class="hljs-keyword">this</span>.options.line_config[line].visible) {
        ...
        <span class="hljs-keyword">this</span>.context.moveTo(x, y);
        <span class="hljs-keyword">this</span>.context.lineTo(x + width, y);
      ...
      <span class="hljs-keyword">this</span>.restoreStyle();
        ...
        <p>Draw the modifiers (bar lines, coda, segno, repeat brackets, etc.)</p>
          ...
          <div class='highlight'><pre>    <span class="hljs-keyword">for</span> (<span class="hljs-keyword">let</span> i = <span class="hljs-number">0</span>; i &lt; <span class="hljs-keyword">this</span>.modifiers.length; i++) {</pre></div>
        ...
        <span class="hljs-keyword">this</span>.modifiers[i].applyStyle(<span class="hljs-keyword">this</span>.context);
        <span class="hljs-keyword">this</span>.modifiers[i].draw(<span class="hljs-keyword">this</span>, <span class="hljs-keyword">this</span>.getModifierXShift(i));
        <span class="hljs-keyword">this</span>.modifiers[i].restoreStyle(<span class="hljs-keyword">this</span>.context);
      }
    }</pre></div>
      ...
      <span class="hljs-keyword">const</span> text_width = <span class="hljs-keyword">this</span>.context.measureText(<span class="hljs-string">''</span> + <span class="hljs-keyword">this</span>.measure).width;
...
Do not delete - draws the beginning bar of the stave</p>
  ...
  drawVerticalFixed(x, isDouble) {
    ...
    <span class="hljs-keyword">const</span> top_line = <span class="hljs-keyword">this</span>.getYForLine(<span class="hljs-number">0</span>);
    <span class="hljs-keyword">const</span> bottom_line = <span class="hljs-keyword">this</span>.getYForLine(<span class="hljs-keyword">this</span>.options.num_lines - <span class="hljs-number">1</span>);
  ...
  setConfigForLine(line_number, line_config) {
    <span class="hljs-keyword">if</span> (line_number &gt;= <span class="hljs-keyword">this</span>.options.num_lines || line_number &lt; <span class="hljs-number">0</span>) {
      <span class="hljs-keyword">throw</span> <span class="hljs-keyword">new</span> Vex.RERR(
        <span class="hljs-string">'StaveConfigError'</span>,
        <span class="hljs-string">'The line number must be within the range of the number of lines in the Stave.'</span>
      );
    }

    <span class="hljs-keyword">if</span> (line_config.visible === <span class="hljs-literal">undefined</span>) {
      <span class="hljs-keyword">throw</span> <span class="hljs-keyword">new</span> Vex.RERR(
        <span class="hljs-string">'StaveConfigError'</span>,
...
eslint-disable-next-line</p>

        
          <div class='highlight'><pre>    <span class="hljs-keyword">for</span> (<span class="hljs-keyword">const</span> line_config <span class="hljs-keyword">in</span> lines_configuration) {</pre></div>
