...
<span class="hljs-keyword">export</span> <span class="hljs-class"><span class="hljs-keyword">class</span> <span class="hljs-title">Factory</span> </span>{
  ...
  Voice(params) {
    ...
    <span class="hljs-keyword">const</span> voice = <span class="hljs-keyword">new</span> Voice(params.time);
  ...
  EasyScore(params = {}) {
    params.factory = <span class="hljs-keyword">this</span>;
    <span class="hljs-keyword">return</span> <span class="hljs-keyword">new</span> EasyScore(params);
  }
  ...
  PedalMarking(params = {}) {
    params = setDefaults(params, {
      <span class="hljs-attr">notes</span>: [],
      <span class="hljs-attr">options</span>: {
        <span class="hljs-attr">style</span>: <span class="hljs-string">'mixed'</span>,
      },
    });

    <span class="hljs-keyword">const</span> pedal = <span class="hljs-keyword">new</span> PedalMarking(params.notes);
    pedal.setStyle(PedalMarking.StylesString[params.options.style]);
    pedal.setContext(<span class="hljs-keyword">this</span>.context);
    <span class="hljs-keyword">this</span>.renderQ.push(pedal);
  ...
  NoteSubGroup(params = {}) {
    ...
    <span class="hljs-keyword">const</span> group = <span class="hljs-keyword">new</span> NoteSubGroup(params.notes);
    group.setContext(<span class="hljs-keyword">this</span>.context);
    <span class="hljs-keyword">return</span> group;
  }

  draw() {
    <span class="hljs-keyword">this</span>.systems.forEach(<span class="hljs-function"><span class="hljs-params">i</span> =&gt;</span> i.setContext(<span class="hljs-keyword">this</span>.context).format());
    <span class="hljs-keyword">this</span>.staves.forEach(<span class="hljs-function"><span class="hljs-params">i</span> =&gt;</span> i.setContext(<span class="hljs-keyword">this</span>.context).draw());
    <span class="hljs-keyword">this</span>.voices.forEach(<span class="hljs-function"><span class="hljs-params">i</span> =&gt;</span> i.setContext(<span class="hljs-keyword">this</span>.context).draw());
    <span class="hljs-keyword">this</span>.renderQ.forEach(<span class="hljs-function"><span class="hljs-params">i</span> =&gt;</span> {
      <span class="hljs-keyword">if</span> (!i.isRendered()) i.setContext(<span class="hljs-keyword">this</span>.context).draw();
    });
    <span class="hljs-keyword">this</span>.systems.forEach(<span class="hljs-function"><span class="hljs-params">i</span> =&gt;</span> i.setContext(<span class="hljs-keyword">this</span>.context).draw());
    <span class="hljs-keyword">this</span>.reset();
  }
}</pre></div>
