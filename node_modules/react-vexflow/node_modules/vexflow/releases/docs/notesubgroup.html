...
Author Taehoon Moon 2016</p>
<h2 id="description">Description</h2>
<p>This file implements <code>NoteSubGroup</code> which is used to format and
render notes as a <code>Modifier</code>
ex) ClefNote, TimeSigNote and BarNote.</p>
...
<span class="hljs-keyword">export</span> <span class="hljs-class"><span class="hljs-keyword">class</span> <span class="hljs-title">NoteSubGroup</span> <span class="hljs-keyword">extends</span> <span class="hljs-title">Modifier</span> </span>{
  <span class="hljs-keyword">static</span> get CATEGORY() { <span class="hljs-keyword">return</span> <span class="hljs-string">'notesubgroup'</span>; }</pre></div>
        ...
        <p>Arrange groups inside a <code>ModifierContext</code></p>
          ...
          <div class='highlight'><pre>  <span class="hljs-keyword">static</span> format(groups, state) {
    <span class="hljs-keyword">if</span> (!groups || groups.length === <span class="hljs-number">0</span>) <span class="hljs-keyword">return</span> <span class="hljs-literal">false</span>;

    <span class="hljs-keyword">let</span> width = <span class="hljs-number">0</span>;
    <span class="hljs-keyword">for</span> (<span class="hljs-keyword">let</span> i = <span class="hljs-number">0</span>; i &lt; groups.length; ++i) {
      <span class="hljs-keyword">const</span> group = groups[i];
      group.preFormat();
  ...
  <span class="hljs-keyword">constructor</span>(subNotes) {
    <span class="hljs-keyword">super</span>();
    <span class="hljs-keyword">this</span>.setAttribute(<span class="hljs-string">'type'</span>, <span class="hljs-string">'NoteSubGroup'</span>);
    ...
    <span class="hljs-keyword">this</span>.subNotes = subNotes;
    <span class="hljs-keyword">this</span>.subNotes.forEach(<span class="hljs-function"><span class="hljs-params">subNote</span> =&gt;</span> { subNote.ignore_ticks = <span class="hljs-literal">false</span>; });
    ...
    <span class="hljs-keyword">this</span>.voice.addTickables(<span class="hljs-keyword">this</span>.subNotes);

    <span class="hljs-keyword">return</span> <span class="hljs-keyword">this</span>;
  }

  getCategory() { <span class="hljs-keyword">return</span> NoteSubGroup.CATEGORY; }
  ...
  draw() {
    ...
    <span class="hljs-keyword">const</span> note = <span class="hljs-keyword">this</span>.getNote();
    ...
    <span class="hljs-keyword">if</span> (!(note &amp;&amp; (<span class="hljs-keyword">this</span>.index !== <span class="hljs-literal">null</span>))) {
      <span class="hljs-keyword">throw</span> <span class="hljs-keyword">new</span> Vex.RuntimeError(<span class="hljs-string">'NoAttachedNote'</span>,
        <span class="hljs-string">"Can't draw notes without a parent note and parent note index."</span>);
    }

    <span class="hljs-keyword">this</span>.setRendered();
    <span class="hljs-keyword">this</span>.alignSubNotesWithNote(<span class="hljs-keyword">this</span>.subNotes, note); <span class="hljs-comment">// Modifier function</span></pre></div>
        ...
        <p>Draw notes</p>
          ...
          <div class='highlight'><pre>    <span class="hljs-keyword">this</span>.subNotes.forEach(<span class="hljs-function"><span class="hljs-params">subNote</span> =&gt;</span> subNote.setContext(<span class="hljs-keyword">this</span>.context).drawWithStyle());
  }
}</pre></div>
